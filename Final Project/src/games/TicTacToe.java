...
//Thought up cause it is a easy game within my ballpark of coding skills.
//Help from stack over flow and youtube
...
{
	JOptionPane.showMessageDialog(null, name + ", you better beat this AI or you don't know jack!");
 ...
 // Then ask the user which letter he/she wants to play.
 System.out.print("Which symbol letter do you want to play as?");
